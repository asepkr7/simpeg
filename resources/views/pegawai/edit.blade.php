                        ...
                        <form action="/petugas/data-pegawai/{{ $data_pegawai->nip }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col md-6">
                                    ...
                                    <select name="agama" id="agama" class="form-control @error('agama') is-invalid @enderror">
                                        <option value="{{ $data_pegawai->agama }}">{{ $data_pegawai->agama }}</option>
                            ...
                            <div class="form-group row">
                                <div class="col-md-6">
                                    ...
                                    <select name="gol_darah" id="gol_darah" class="form-control">
                                        <option value="{{ $data_pegawai->gol_darah }}">{{ $data_pegawai->gol_darah }}</option>
                                        ...
                                        <option value="Tidak Tahu" {{ old('gol_darah') =='Tidak '? 'selected' : '' }}>Tidak Tahu</option>
                                    </select>
                                </div>
                                <div class="col md-6">
                                    <label for="status_pernikahan">Status Pernikahan</label>
                                    <select name="status_pernikahan" id="status_pernikahan" class="form-control">
                                        <option value="{{ $data_pegawai->status_pernikahan }}">{{ $data_pegawai->status_pernikahan }}</option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col md-6">
                                    ...
                                    <select name="status_kepegawaian" id="status_kepegawaian" class="form-control @error('status_kepegawaian') is-invalid @enderror">
                                        <option value="{{ $data_pegawai->status_kepegawaian }}">{{ $data_pegawai->status_kepegawaian }}</option>
                            ...
                            <div class="form-group row">
                                <div class="col-md-6">
                                    ...
                                    <input value="{{ old('tpp',$data_pegawai->tpp) }}" type="text" id="tpp" name="tpp" class="form-control @error('tpp') is-invalid @enderror" id="tpp">
                                    @error('tpp')
                                  <div class="invalid-feedback">
                                    {{ $message }}
                                  </div>
